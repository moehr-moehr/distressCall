...
ds 9 ; $C207..$C20F - Unused
pauseMapResumeH: ds 2 ; $C210 - $C211 - pause map resume hl
pauseMapResumeD: ds 2 ; $C212 - $c213 - pause map resume de
ds 1 ; unused
...
;{
saveBuffer: ; $26 bytes 
			; - now 29 with the map ones added
...
saveBuf_newItemsEquipped: ds 1 ; d828, just for grav, which is itemBit_GRAV, which is 0
;}
...
mapItemsFound:: ds $01
enemyBreakBlockFlag:: ds $01 ;veil enemy breakable block flag
...
newItemsEquipped: ds $01 ;IN USE for added items such as pseudo-gravity which is bit 0
mapWram:: ds $71 ;IN USE map sprite buffer data
