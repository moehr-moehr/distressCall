...
weaponDamageTable: ; 02:43C8
    ...
    db $08 ; $02 - Wave Beam
    db $10 ; $03 - Spazer Beam
    db $08 ; $04 - Plasma Beam (30!?)
    db $00 ; $05 - x
    db $00 ; $06 - x
    db $02 ; $07 - Bomb Beam !?
...
.getItemNum:
    ...
    ld a, c
	;this next block checks for if it is one of these 2 new items, and if so, adjusts the handler to work with the other code, 
	;putting the newest items to the end of the item get handler in bank 0
	cp $80
	jr nc, .doneNewitems
		add a, $7A
	.doneNewitems:
...
.spewBlob:
			;veil prevent enemy overflow crash
			ld a, [numEnemies.total]
			cp preventCrash
			ret nc
...
.sprite: ; 02:4FFE
    ...
    db $10, $FC, $D4, $00
    db $10, $04, $D3, $20
    db $FF, $F0, $D8, $00 ; Note the $FF. It's dynamically changed to a valid value so this sprite and the next appear conditionally.
    db $E8, $08, $D8, $20
    db $FF
.hitbox: ; 02:503B
    db $FC, $18, $F8, $08
...
; x-version, for when you have moving up add to y and moving down add to x
;    db $00, $F9, $FB, $FC, $FC, $FE, $FE, $FF, $00, $00, $01, $02, $02, $04, $04, $05
;    db $07, $07, $05, $04, $04, $02, $02, $01, $00, $00, $FF, $FE, $FE, $FC, $FC, $FB
;    db $F9
    db $00, $01, $01, $02, $04, $05, $06, $06, $06, $05, $05, $05, $04, $04, $04, $04
    db $03, $03, $03, $03, $03, $02, $02, $02, $02, $01, $01, $01, $01, $01, $01, $01
    db $00

.projectileHeader: ; 02:5A9E
    db $00, $00, $00, $0C, $00, $00, $ff, $07
    dw enAI_skreek
...
;idleMotion: ; bob up and down
	;veil descend if higher than Samus
...
.break:
    ...
    add [hl]
    ldh [hEnemy.xPos], a
	;now, animate based on new animation table
	call .animate
...
.gullogAnimateTable: ; 02:5D0C
    db $DA, $DA, $DA, $DA, $D9, $D9, $D9, $D9, $D9, $D9, $D9, $D8, $D8, $D8, $D8, $D8
    db $D8, $D8, $D8, $D9, $D9, $D9, $D9, $D9, $D9, $D9, $DA, $DA, $DA, $DA, $DA, $DA
    db $DA, $DA, $D9, $D9, $D9, $D9, $D9, $D9, $D9, $D8, $D8, $D8, $D8, $D8, $D8, $D8
    db $D8, $D9, $D9, $D9, $D9, $D9, $D9, $D9, $DA, $DA, $DA, $DA, $80
...
.xSpeedTable_cw: ; 02:5DC2
    db $05, $04, $03, $02, $02, $01, $01, $00, $FF, $FF, $FE, $FE, $FD, $FC, $FB, $FB
    db $FC, $FD, $FE, $FE, $FF, $FF, $00, $01, $01, $02, $02, $03, $04, $05, $05, $04
    db $03, $02, $02, $01, $01, $00, $FF, $FF, $FE, $FE, $FD, $FC, $FB, $FB, $FC, $FD
    db $FE, $FE, $FF, $FF, $00, $01, $01, $02, $02, $03, $04, $05
...
.fireLaser:
	...
	jr nc, .else_C
			;set attrs
		    ldh a, [hEnemy.attr]
			;this is wrong and should be and a, $DF
			or a, $00
			ld b, a
        ldh a, [hEnemy.xPos]
        sub $08
...
; Vertical case
    ...
    dec a ; State 1 - Fire a shot based on the global timer, and move
        jp z, .shootHorizontalRegular ; State 1
...
;    call enemy_flipHorizontal.fourFrame ; Animate
    ...
    jr z, .else_A
        ...
        ld [hl], a
		call enemy_flipHorizontal.now ; Animate
            ret
    .else_A:
...
;    ldh a, [hEnemy.stunCounter]
;		ret nz
	;if not stunned, and counter is at zero, fire immediately, then wait a bit
	ld hl, hEnemy.generalVar
	inc [hl]
	ld a, [hl]
	cp $C0
...
.death:
    ...
    call earthquakeCheck_farCall
			;veil add killedTarget to update mapdots after metroid fight
			;m2maps: store enemy WRAM to do update to clear item dot
            ld a, [hEnemyWramAddrLow]
            ld [clearItemDotLow], a
            ld a, [hEnemyWramAddrHigh]
...
maybeBreakBlock:
	;forklift break block plz
	ld a, $01
	ld [enemyBreakBlockFlag], a
	ld a, [scrollY]
	ld b, a
	ld a, [enemy_testPointYPos]
	add b
...
;	sub $04
    ...
    cp $04
    jr nc, .else_dont
        call destroyRespawningBlock_farCall
		.else_do:
		call enemy_deleteSelf_farCall
	.else_dont:
ret
...
.fireWallHeader: ; 02:52D2 - Enemy header
...
fireGadoraBeam:
	...
	.placedBeamX:
	ld [hl+], a
	ld a, $dc ; $dc for gadora beam
	ld [hl+], a
	ld a, $00
	ld [hl+], a
	ldh a, [hEnemy.attr]
	ld [hl+], a
	ld de, .gadoraBeamHeader
	call enemy_createLinkForChildObject
	call enemy_spawnObject.shortHeader
	ld a, $03
	ldh [hEnemy.spawnFlag], a
...
.gadoraBeamHeader: ; 02:52D2 - Enemy header
    db $00, $00, $00, $00, $00, $00, $02, $08
    dw .gadoraBeamAI
.gadoraBeamAI: ; 02:52DF
	;determine if Y has been set and if not, set Y
	ld a, [hEnemy.generalVar]
	cp $00
	jr nz, .angleSet
		ld a, [samus_onscreenYPos]
		ld b, a
	...
	.caseMove:
	cp $10
	jr nc, .caseMoveFaster	
		ld c, $02
		jr .next
	.caseMoveFaster:
	cp $18
	jr nc, .caseMoveFastest
		ld c, $03
		jr .next
	.caseMoveFastest:
		ld c, $04
...
;for updating map dots on eliminating a target
killedTarget:
	push de
	push af
