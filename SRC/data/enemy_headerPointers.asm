; This file was automatically generated from enemies.csv. Please do not edit this directly.
    ...
    dw enHead_NULL ; Needler
    dw enHead_item ; Displacer Orb
    dw enHead_item ; Displacer
    dw enHead_item ; Dash boots Orb Orb
    dw enHead_item ; Dash Boots
    ...
    dw enHead_NULL ; GadoraBeam
    dw enHead_missileDoor ; gadoraShut
    dw enHead_NULL ; (no graphics)
    dw enHead_NULL ; (no graphics)
