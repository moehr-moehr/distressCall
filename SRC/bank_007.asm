...
;ruinsExt is in bank 8 at HxD 227BC
gfx_plantBubbles:: incbin "tilesets/plantBubbles.chr",0,$800 ;1C000
gfx_ruinsInside::  incbin "tilesets/ruinsInside.chr", 0,$800 ;1C800
gfx_queenBG::      incbin "tilesets/queenBG.chr",     0,$800
gfx_caveFirst::    incbin "tilesets/caveFirst.chr",   0,$800 ;1D800
gfx_surfaceBG::    incbin "tilesets/surfaceBG.chr",   0,$800 ;1E000
