...
metatiles_plantBubbles:   include "tilesets/plantBubbles_metatiles.asm"		;20880
metatiles_ruinsInside:    include "tilesets/ruinsInside_metatiles.asm"		;20A80
metatiles_finalLab:       include "tilesets/finalLab_metatiles.asm"			;20C80
metatiles_queen:          include "tilesets/queen_metatiles.asm"			;;20E80?
metatiles_caveFirst:      include "tilesets/caveFirst_metatiles.asm"		;21080
metatiles_surface:        include "tilesets/surface_metatiles.asm"			;21280
metatiles_lavaCavesMid:   include "tilesets/lavaCavesMid_metatiles.asm" 	;21480
metatiles_lavaCavesEmpty: include "tilesets/lavaCavesEmpty_metatiles.asm"	;21590
metatiles_lavaCavesFull:  include "tilesets/lavaCavesFull_metatiles.asm"	;216A8
metatiles_ruinsExt:       include "tilesets/ruinsExt_metatiles.asm"			;217BC
...
gfx_ruinsExt:: incbin "tilesets/ruinsExt.chr",0,$800 ;;227BC?
...
;placeholder, move earthquake threshholds back here if this doesn't help
...
quakeThresholds:
    db $20, $19, $18, $17, $16, $15, $14, $13, $12, $11, $10, $09, $08, $07, $06, $05, $04, $03, $02, $01, $00, $ff
;}
